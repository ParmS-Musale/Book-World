...
import { useAuth } from "../context/AuthProvider"; // Ensure useAuth is imported from the correct path
import Login from "./Login"; // Ensure the Login component is imported correctly
import Logout from "./Logout"; // Ensure the Login component is imported correctly
      ...
      <div className="navbar">
        ...
        <div className="navbar-end space-x-3">
          ...
          {authUser ? (
            ...
            <div className ="">
              <a
                className="bg-black text-white px-3 py-2 rounded-md hover:bg-slate-800 cursor-pointer duration-300 cursor-pointer-"
                onClick={() =>
